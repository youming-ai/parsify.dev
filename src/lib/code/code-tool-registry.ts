...
import { type ToolConfig, type ToolMetadata, ToolRegistry } from '@/lib/registry/tool-registry';
...
const importPythonWasm = () =>
  import('@/lib/runtimes/python-wasm').then((mod) => mod.PythonRuntime);
const importJavaWasm = () => import('@/lib/runtimes/java-wasm').then((mod) => mod.JavaRuntime);
const importGoWasm = () => import('@/lib/runtimes/go-wasm').then((mod) => mod.GoRuntime);
const importRustWasm = () => import('@/lib/runtimes/rust-wasm').then((mod) => mod.RustRuntime);
const importTypeScriptWasm = () =>
  import('@/lib/runtimes/typescript-wasm').then((mod) => mod.TypeScriptRuntime);
