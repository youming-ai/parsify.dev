...
export function registerCodeExecutionTools(): void {
  ...
  toolRegistry.registerTool({
    metadata: {
      ...
      description:
        "Execute Python code in a WebAssembly sandbox with Pyodide runtime and package management",
      category: "code",
      version: "1.0.0",
    ...
    component: lazy(() =>
      import("../../components/tools/code-execution/python-executor").then((m) => ({
  ...
  toolRegistry.registerTool({
    ...
    component: lazy(() =>
      import("../../components/tools/code-execution/java-executor").then((m) => ({
  ...
  toolRegistry.registerTool({
    ...
    component: lazy(() =>
      import("../../components/tools/code-execution/go-executor").then((m) => ({
  ...
  toolRegistry.registerTool({
    metadata: {
      ...
      name: "Rust Executor",
      description:
        "Compile and execute Rust code with native WebAssembly compilation and Cargo-like features",
      category: "code",
      version: "1.0.0",
    ...
    component: lazy(() =>
      import("../../components/tools/code-execution/rust-executor").then((m) => ({
  ...
  toolRegistry.registerTool({
    ...
    component: lazy(() =>
      import("../../components/tools/code-execution/typescript-transpiler").then((m) => ({
  ...
  toolRegistry.registerTool({
    metadata: {
      ...
      description:
        "Secure sandbox environment for executing code with configurable security constraints and resource limits",
      category: "code",
      version: "1.0.0",
    ...
    component: lazy(() =>
      import("../../components/tools/code-execution/execution-sandbox").then((m) => ({
  ...
  toolRegistry.registerTool({
    metadata: {
      ...
      description:
        "Comprehensive console output capture and management system with filtering and export capabilities",
      category: "code",
      version: "1.0.0",
    ...
    component: lazy(() =>
      import("../../components/tools/code-execution/console-manager").then((m) => ({
  ...
  toolRegistry.registerTool({
    metadata: {
      ...
      description:
        "Centralized management for multiple language WebAssembly runtimes with lazy loading and lifecycle management",
      category: "code",
      version: "1.0.0",
    ...
    component: lazy(() =>
      import("../../components/tools/code-execution/wasm-runtime-manager").then((m) => ({
 ...
 */
export function getCodeExecutionTimeouts(): Record<
  string,
  {
    default: number;
    maximum: number;
 ...
 */
export function getCodeExecutionMemoryLimits(): Record<
  string,
  {
    default: number; // MB
    maximum: number; // MB
 ...
 */
export function getCodeExecutionSecurityLevels(): Record<
  string,
  {
...
export async function initializeCodeExecutionTools(): Promise<void> {
  try {
    ...
    const essentialTools = ["console-manager", "execution-sandbox", "wasm-runtime-manager"];
