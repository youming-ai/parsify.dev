...
import type { ToolMetadata, ToolConfig } from './tool-registry';
...
export class ToolDiscovery {
   ...
   */
  private async discoverToolsInPath(path: string): Promise<DiscoveredTool[]> {
   ...
   */
  private async getKnownToolDefinitions(): Promise<Array<{
    id: string;
    path: string;
    ...
    return [
      // JSON Tools
      {
        ...
        importer: () => import(/* webpackChunkName: "tool-json-formatter" */ '@/components/tools/json/json-formatter'),
      },
      {
        id: 'json-minifier',
        ...
        importer: () => import(/* webpackChunkName: "tool-json-minifier" */ '@/components/tools/json/json-minifier'),
      },
      {
        id: 'json-validator',
        ...
        importer: () => import(/* webpackChunkName: "tool-json-validator" */ '@/components/tools/json/json-validator'),
      },
      ...
      // Crypto Tools
      {
        ...
        importer: () => import(/* webpackChunkName: "tool-aes-encryptor" */ '@/components/tools/crypto/aes-encryptor'),
      },
      {
        id: 'hash-generator',
        ...
        importer: () => import(/* webpackChunkName: "tool-hash-generator" */ '@/components/tools/crypto/hash-generator'),
      },
      {
        id: 'base64-encoder',
        ...
        importer: () => import(/* webpackChunkName: "tool-base64-encoder" */ '@/components/tools/crypto/base64-encoder'),
      },
      ...
      // Code Execution Tools
      {
        ...
        importer: () => import(/* webpackChunkName: "tool-python-runner" */ '@/components/tools/code/python-runner'),
      },
      {
        ...
        importer: () => import(/* webpackChunkName: "tool-javascript-runner" */ '@/components/tools/code/javascript-runner'),
      },
      {
        ...
        importer: () => import(/* webpackChunkName: "tool-typescript-runner" */ '@/components/tools/code/typescript-runner'),
      },
      ...
      // Image Processing Tools
      {
        ...
        importer: () => import(/* webpackChunkName: "tool-image-converter" */ '@/components/tools/image/image-converter'),
      },
      {
        id: 'image-resizer',
        ...
        importer: () => import(/* webpackChunkName: "tool-image-resizer" */ '@/components/tools/image/image-resizer'),
      },
      {
        ...
        importer: () => import(/* webpackChunkName: "tool-qr-code-generator" */ '@/components/tools/image/qr-code-generator'),
      },
      ...
      // Network Tools
      {
        ...
        importer: () => import(/* webpackChunkName: "tool-url-encoder" */ '@/components/tools/network/url-encoder'),
      },
      {
        id: 'http-client',
        ...
        importer: () => import(/* webpackChunkName: "tool-http-client" */ '@/components/tools/network/http-client'),
      },
    ];
  }
  ...
  private async validateConstitutionalCompliance(metadata: ToolMetadata): Promise<string[]> {
    ...
    if (metadata.requiresWasm && !metadata.dependencies.some(dep => dep.includes('pyodide') || dep.includes('wasm'))) {
