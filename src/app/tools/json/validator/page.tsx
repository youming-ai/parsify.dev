							...
							{jsonInput.trim() ? (
								<div className="space-y-4">
									...
									<div className="flex items-center gap-2">
										...
										/>
										<span className="font-medium">{validationResult.isValid ? 'Valid JSON' : 'Invalid JSON'}</span>
									</div>
								...
								<div className="text-center py-8 text-gray-500">
									...
									<p className="text-sm mt-1">The validator will check for syntax errors in real-time</p>
								</div>
							)}
						</CardContent>
					</Card>
