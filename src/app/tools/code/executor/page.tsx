...
function CodeExecutorWrapper() {
	return (
		<div className="p-6 text-center">
			<p className="text-gray-600">Code Executor tool is coming soon!</p>
			<p className="text-gray-500 text-sm mt-2">
				This tool will allow you to execute code in a secure WASM sandbox with multiple language support.
			</p>
		</div>
	);
}
