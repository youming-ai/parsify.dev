					...
					<CardContent>
						<ul className="space-y-2">
							<li className="flex items-start gap-2">
								...
								<span className="text-gray-700 dark:text-gray-300">Custom validation rules with multiple field types</span>
							</li>
							<li className="flex items-start gap-2">
								<div className="mt-1 h-2 w-2 rounded-full bg-blue-600"></div>
								<span className="text-gray-700 dark:text-gray-300">Schema validation for JSON, XML, CSV, YAML</span>
							</li>
							<li className="flex items-start gap-2">
								<div className="mt-1 h-2 w-2 rounded-full bg-blue-600"></div>
								<span className="text-gray-700 dark:text-gray-300">Batch validation with detailed error reporting</span>
							</li>
							<li className="flex items-start gap-2">
								<div className="mt-1 h-2 w-2 rounded-full bg-blue-600"></div>
								<span className="text-gray-700 dark:text-gray-300">Predefined templates for common validations</span>
							</li>
							<li className="flex items-start gap-2">
								<div className="mt-1 h-2 w-2 rounded-full bg-blue-600"></div>
								<span className="text-gray-700 dark:text-gray-300">Regex pattern matching and custom logic</span>
							</li>
						</ul>
					</CardContent>
				</Card>
					...
					<CardContent>
						<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
							...
							<div className="p-4 border rounded">
								...
								<p className="text-sm text-gray-600">
									Key-value pair form data validation
								</p>
							</div>
						</div>
					</CardContent>
						...
						<div className="grid md:grid-cols-2 gap-6">
							<div>
								...
								<ul className="space-y-2 text-sm">
									...
									<li><strong>URL:</strong> Valid URL format checking</li>
									<li><strong>Number:</strong> Numeric value validation</li>
									<li><strong>Length:</strong> String length constraints</li>
									<li><strong>Range:</strong> Numeric range validation</li>
								</ul>
							</div>
							<div>
								<h4 className="font-medium mb-3">Pattern Matching</h4>
								<ul className="space-y-2 text-sm">
									<li><strong>Regex:</strong> Regular expression patterns</li>
									<li><strong>Contains:</strong> Substring matching</li>
									<li><strong>Starts With:</strong> Prefix validation</li>
									<li><strong>Ends With:</strong> Suffix validation</li>
									<li><strong>Equals:</strong> Exact value matching</li>
									<li><strong>Custom:</strong> Custom validation logic</li>
								</ul>
							</div>
						</div>
					</CardContent>
				...
				<Card>
					...
					<CardContent className="space-y-4">
						<div>
							...
							<p className="text-gray-600 text-sm">
								Validate multiple records or objects simultaneously with detailed reporting for each item.
							</p>
						</div>
						<div>
								...
								<div className="flex items-start gap-2">
									...
									<div>
										...
										<div className="text-sm text-yellow-700">
											This tool is currently experimental and may have limitations in complex validation scenarios.
										</div>
									</div>
								</div>
							</div>
							<ul className="text-sm text-gray-600 space-y-1">
								<li>• YAML parsing is basic (full implementation would require additional libraries)</li>
