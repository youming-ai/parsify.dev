					...
					<CardContent>
						<ul className="space-y-2">
							<li className="flex items-start gap-2">
								...
								<span className="text-gray-700 dark:text-gray-300">Search and replace with regex support</span>
							</li>
							<li className="flex items-start gap-2">
								<div className="mt-1 h-2 w-2 rounded-full bg-blue-600"></div>
								<span className="text-gray-700 dark:text-gray-300">Multiple text encoding support (UTF-8, Base64, URL)</span>
							</li>
							<li className="flex items-start gap-2">
								<div className="mt-1 h-2 w-2 rounded-full bg-blue-600"></div>
								<span className="text-gray-700 dark:text-gray-300">Case conversion tools (camelCase, snake_case, etc.)</span>
							</li>
							<li className="flex items-start gap-2">
								<div className="mt-1 h-2 w-2 rounded-full bg-blue-600"></div>
								<span className="text-gray-700 dark:text-gray-300">Line ending normalization (LF, CRLF, CR)</span>
							</li>
							<li className="flex items-start gap-2">
								<div className="mt-1 h-2 w-2 rounded-full bg-blue-600"></div>
								<span className="text-gray-700 dark:text-gray-300">Real-time preview and statistics</span>
							</li>
						</ul>
					</CardContent>
				</Card>
				...
				<Card>
					...
					<CardContent className="space-y-4">
						...
						<div>
							...
							<p className="text-gray-600 text-sm">
								Replace multiple occurrences of text patterns using normal search or regular expressions.
							</p>
						</div>
						<div>
						...
						<div>
							...
							<p className="text-gray-600 text-sm">
								Convert variable naming conventions between camelCase, snake_case, PascalCase, and kebab-case.
							</p>
						</div>
					</CardContent>
				</Card>
