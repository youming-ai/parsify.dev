    ...
    <div className="container mx-auto py-6">
      ...
      <div className="mb-6">
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-3xl text-gray-900 dark:text-white">File Converter</h1>
          ...
          <CardContent>
            <ul className="space-y-2">
              ...
              <li className="flex items-start gap-2">
                <div className="mt-1 h-2 w-2 rounded-full bg-blue-600"></div>
                <span className="text-gray-700 dark:text-gray-300">
                  Preview mode to verify conversions
                </span>
              </li>
              <li className="flex items-start gap-2">
                <div className="mt-1 h-2 w-2 rounded-full bg-blue-600"></div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                Select your desired output format from the available options based on your file
                type.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                Process your files and download the converted versions individually or as a ZIP
                archive.
              </p>
            </div>
          </CardContent>
