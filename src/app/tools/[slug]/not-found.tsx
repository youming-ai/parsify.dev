...
export default function ToolNotFound() {
	...
	const categories = Array.from(
		new Set(['JSON Processing', 'Code Execution', 'File Processing', 'Data Validation', 'Utilities']),
	);
		...
		<div className="container mx-auto py-6">
			...
			<div className="py-16 text-center">
				...
				<p className="mx-auto mb-8 max-w-2xl text-gray-600 text-lg">
					The tool you're looking for doesn't exist or has been moved. Browse our available tools below or search for
					what you need.
				</p>
							...
							<Card key={category} className="cursor-pointer transition-shadow hover:shadow-md">
								<Link href={`/tools?category=${encodeURIComponent(category)}`}>
									<CardHeader className="pb-3">
										...
										<CardDescription className="text-sm">{toolsInCategory.length} tools available</CardDescription>
									</CardHeader>
								</Link>
							</Card>
						);
			...
			<div className="text-center">
				<Card className="mx-auto max-w-2xl">
					<CardHeader>
						...
						<CardDescription>Try searching for a specific tool or browse our complete collection</CardDescription>
					</CardHeader>
					<CardContent>
						<Link href="/tools">
