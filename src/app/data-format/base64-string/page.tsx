            ...
            <CardContent className="space-y-4 pt-6">
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  Base64 converts binary data into a text format using 64 different ASCII
                  characters. This makes it safe to transmit binary data over text-based protocols
                  like email.
                </p>
              </div>
              <div>
