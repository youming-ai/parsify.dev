	...
	return (
		<div className={cn('inline-block', className)}>
			<Button
				...
				className={cn('relative', error && 'border-red-500 text-red-600 hover:border-red-600 hover:text-red-700')}
			>
				{isDownloading ? (
					<>
			...
			{showProgress && isDownloading && (
				<div className="mt-2 max-w-xs text-gray-500 text-xs">Downloading {formatFileSize(file.size)}...</div>
			)}
		</div>
	);
};
