import { COMMON_MIME_TYPES, type FileUploadOptions, type FileValidationError } from './file-upload-types';
...
export function isPreviewable(file: File): boolean {
	const previewableMimeTypes = [...COMMON_MIME_TYPES.JSON, ...COMMON_MIME_TYPES.TEXT, ...COMMON_MIME_TYPES.IMAGE];
