				...
				<CardHeader className="pb-3">
					<div className="flex items-center justify-between">
						<CardTitle className="flex items-center gap-2 text-lg">
							{getStatusIcon()}
							Code Execution
							<Badge variant={getStatusColor() as any}>{status.charAt(0).toUpperCase() + status.slice(1)}</Badge>
						</CardTitle>
				...
				<Card>
					...
					<CardContent className="space-y-4">
						...
						{showCompileOutput && result.compileOutput && (
							<div>
								<h4 className="mb-2 font-medium text-blue-700 dark:text-blue-400">Compile Output</h4>
								<div
