			...
			<div className="border-b bg-gray-50 px-3 py-2 dark:bg-gray-800">
				<div className="flex items-center justify-between">
					<div className="flex items-center space-x-2">
						<span className="font-medium text-gray-700 text-sm dark:text-gray-300">{languageConfig.name}</span>
						{languageConfig.version && (
							<span className="text-gray-500 text-xs dark:text-gray-400">v{languageConfig.version}</span>
						)}
					</div>
					{onLanguageChange && (
						<select
