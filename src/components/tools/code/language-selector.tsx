							...
							return (
								<button
									...
									className={cn(
										...
										selectedLanguage === language && 'bg-blue-50 text-blue-600 dark:bg-blue-900/20 dark:text-blue-400',
									)}
								>
				...
				<div className="absolute top-full right-0 left-0 z-50 mt-2 max-h-96 overflow-hidden rounded-lg border bg-white shadow-lg dark:bg-gray-800">
					...
					<div className="max-h-64 overflow-y-auto">
						{filteredLanguages.length === 0 ? (
							<div className="p-4 text-center text-gray-500 dark:text-gray-400">No languages found</div>
						) : (
							<div className="p-2">
								{filteredLanguages.map((language) => {
									const config = getLanguageConfig(language);
										...
										>
											<div className="flex items-center gap-3">
												...
												<div>
													...
													<div className="text-gray-500 text-xs dark:text-gray-400">{config.extensions.join(', ')}</div>
												</div>
											</div>
											<div className="flex items-center gap-2">
												{showVersion && (
