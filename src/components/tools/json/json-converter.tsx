...
export function JsonConverter({ input, options, onConvert, onError, className }: JsonConverterProps) {
	...
	return (
		<div className={cn('space-y-4', className)}>
					...
					>
						...
						<TabsContent value="xml" className="space-y-4">
							<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
								<div>
									<label className="mb-1 block font-medium text-gray-700 text-sm">Root Element Name</label>
									<input
										type="text"
								...
								<div>
									<label className="mb-1 block font-medium text-gray-700 text-sm">Array Item Name</label>
									<input
										type="text"
						...
						<TabsContent value="csv" className="space-y-4">
							<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
								<div>
									<label className="mb-1 block font-medium text-gray-700 text-sm">CSV Delimiter</label>
									<select
								...
								<div>
									<label className="mb-1 block font-medium text-gray-700 text-sm">Flatten Objects</label>
							...
							<div className="rounded-md border border-yellow-200 bg-yellow-50 p-3">
								<p className="text-sm text-yellow-800">
									<strong>Note:</strong> CSV conversion requires an array of objects. Each object's keys will become the
									CSV headers.
								</p>
							</div>
						</TabsContent>
			...
			<div className="flex items-center gap-2">
				<Button onClick={handleConvert} disabled={isConverting || !input.trim()} className="flex items-center gap-2">
