			...
			<Tabs defaultValue="editor" className="w-full">
				...
				<TabsContent value="editor" className="space-y-4">
					<div className="space-y-4">
						<div className="flex items-center justify-between">
							...
							<button onClick={() => setJsonInput(sampleJson)} className="text-blue-600 text-sm hover:text-blue-800">
								Load Sample
							</button>
						</div>
						<JsonInputEditor
				...
				<TabsContent value="viewer" className="space-y-4">
					<div className="space-y-4">
						...
						{parsedData ? (
							<JsonViewer data={parsedData} expandLevel={3} showLineNumbers={true} copyable={true} />
						) : (
				...
				<TabsContent value="validator" className="space-y-4">
					<div className="space-y-4">
						...
						<JsonValidator input={jsonInput} onValidationChange={handleValidationChange} showLineNumbers={true} />
					</div>
				</TabsContent>
