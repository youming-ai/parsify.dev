 ...
 */
function MicrosoftClarityProviderInner({ projectId, enabled, debug }: MicrosoftClarityProviderInnerProps) {
 ...
 */
export function MicrosoftClarityProvider({ children, projectId, enabled, debug }: MicrosoftClarityProviderProps) {
	return (
		<>
