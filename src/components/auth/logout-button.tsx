		...
		return (
			<div className="space-y-3">
				...
				<div className="flex gap-2">
					<Button variant="destructive" onClick={handleLogout} disabled={isLoggingOut} className="flex-1">
						{isLoggingOut ? 'Signing out...' : 'Yes, sign out'}
					</Button>
					<Button variant="outline" onClick={handleCancel} disabled={isLoggingOut} className="flex-1">
						Cancel
					</Button>
				</div>
			</div>
