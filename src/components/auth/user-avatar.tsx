...
export function UserAvatar({ user, size = 'md', className, showStatus = false, status = 'offline' }: UserAvatarProps) {
	...
	if (user.avatar) {
		return (
			<div className="relative inline-block">
				<img src={user.avatar} alt={user.name} className={cn(sizeClass, 'rounded-full object-cover', className)} />
				{showStatus && (
					<span
						className={cn(
