...
interface AuthContextType extends AuthState {
	login: (provider: 'google' | 'github' | 'email', credentials?: Record<string, unknown>) => Promise<void>;
	logout: () => Promise<void>;
...
export function AuthProvider({ children }: { children: ReactNode }) {
	...
	const login = async (provider: 'google' | 'github' | 'email', credentials?: Record<string, unknown>) => {
		try {
			dispatch({ type: 'AUTH_START' });
