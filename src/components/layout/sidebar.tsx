...
import { ChevronDown, ChevronRight, Clock, Code, FileJson, FileText, Hash, Star } from 'lucide-react';
							...
							<div className="space-y-1">
								{quickActions.map((action) => (
									<Link key={action.href} href={action.href}>
										<Button variant={pathname === action.href ? 'secondary' : 'ghost'} className="w-full justify-start">
