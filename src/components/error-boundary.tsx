				...
				<div className="flex min-h-screen items-center justify-center bg-gray-50">
					<div className="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
						<div className="mb-4 flex items-center">
							...
							<div className="ml-3">
								<h1 className="font-medium text-gray-900 text-lg">Something went wrong</h1>
						...
						{process.env.NODE_ENV === 'development' && this.state.error && (
							<details className="mt-4 rounded bg-red-50 p-3 text-sm">
								<summary className="cursor-pointer font-medium text-red-800">Error Details (Development Mode)</summary>
