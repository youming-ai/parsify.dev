...
import { FilePreviewOptions, UploadedFile } from './file-upload-types'
      ...
      return (
        <div className="flex items-center justify-center h-32 text-gray-500">
          <div className="text-center">
            ...
            <p className="text-xs mt-1">File type: {file.type || 'Unknown'}</p>
          </div>
        </div>
      )
    }
          ...
          <div className="overflow-auto" style={{ maxHeight }}>
            <pre className={cn(
              ...
              {showLineNumbers ? (
                <div className="flex">
                  <div className={cn(
                    'pr-4 select-none text-right border-r',
