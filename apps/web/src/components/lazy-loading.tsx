...
export const LazyCodeFormatter = () => (
	<LazyWrapper
		loader={() =>
			import('@/components/tools/code/code-formatter').then((mod) => ({
				default: mod.CodeFormatter,
			}))
		}
...
export const LazyCodeExecutor = () => (
	<LazyWrapper
		loader={() =>
			import('@/components/tools/code/code-execution').then((mod) => ({
				default: mod.CodeExecution,
			}))
		}
...
export const LazyJsonConverter = () => (
	<LazyWrapper
		loader={() =>
			import('@/components/tools/json/json-converter').then((mod) => ({
				default: mod.JsonConverter,
			}))
		}
...
export const LazyFileUpload = () => (
	<LazyWrapper
		loader={() =>
			import('@/components/file-upload/file-upload-component').then((mod) => ({
				default: mod.FileUploadComponent,
			}))
		}
...
export const LazyAuthLoginPage = createLazyComponent(
...
export const LazyAuthSignupPage = createLazyComponent(
