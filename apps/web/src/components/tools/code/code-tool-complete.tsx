...
export function CodeToolComplete({ className }: CodeToolCompleteProps) {
	...
	const [executionStatus, setExecutionStatus] =
		React.useState<ExecutionStatusEnum>('idle');
	const [executionResult, setExecutionResult] =
		React.useState<CodeExecutionResult | null>(null);
	...
	const [_selectedTemplate, setSelectedTemplate] =
		React.useState<CodeTemplate | null>(null);
	...
	const handleCancelExecution = () => {
		...
		const cancelLine = createTerminalLine(
	...
	const handleFormat = (formatted: string) => {
		...
		const formatLine = createTerminalLine(
	...
	const handleUploadCode = (event: React.ChangeEvent<HTMLInputElement>) => {
		...
		if (file) {
			...
			reader.onload = (e) => {
				...
				const uploadLine = createTerminalLine(
