...
export function JsonConverter({
	...
	const [conversionOptions, setConversionOptions] =
		React.useState<JsonConversionOptions>(options);
	...
	const handleDownload = () => {
		...
		downloadFile(
			convertedOutput,
			filename,
			mimeTypes[conversionOptions.targetFormat]
		);
	};
					...
					>
							...
							<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
								<div>
									...
									<input
										...
										onChange={(e) =>
											handleOptionChange('rootElement', e.target.value)
										}
								...
								<div>
									...
									<input
										...
										onChange={(e) =>
											handleOptionChange('arrayItemName', e.target.value)
										}
										className="w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
										placeholder="item"
									/>
						...
						<TabsContent value="yaml" className="space-y-4">
							<p className="text-gray-600 text-sm">
								YAML conversion uses standard YAML formatting with proper
								indentation.
							</p>
						</TabsContent>
						...
						<TabsContent value="csv" className="space-y-4">
							<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
								<div>
									...
									<select
										...
										onChange={(e) =>
											handleOptionChange('csvDelimiter', e.target.value)
										}
										className="w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
									>
								...
								<div>
									...
									<div className="flex items-center">
										<input
											...
											onChange={(e) =>
												handleOptionChange('flatten', e.target.checked)
											}
											className="mr-2"
										/>
										<label
							...
							<div className="rounded-md border border-yellow-200 bg-yellow-50 p-3">
								<p className="text-sm text-yellow-800">
									<strong>Note:</strong> CSV conversion requires an array of
									objects. Each object's keys will become the CSV headers.
								</p>
							</div>
						</TabsContent>
					</Tabs>
				...
				<Card>
					...
					<CardContent>
						...
						<div className="mt-2 text-gray-600 text-sm">
							...
							{convertedOutput.length} characters
						</div>
					</CardContent>
				</Card>
			)}
