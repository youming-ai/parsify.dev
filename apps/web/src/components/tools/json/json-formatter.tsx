...
export function JsonFormatter({
	...
	const [formatOptions, setFormatOptions] =
		React.useState<JsonFormatOptions>(options);
							...
							<div className="space-y-2">
								...
								<div className="flex items-center">
									<input
										...
										onChange={(e) =>
											handleOptionChange('sortKeys', e.target.checked)
										}
										className="mr-2"
									/>
							...
							<div className="space-y-2">
								...
								<div className="flex items-center">
									<input
										...
										onChange={(e) =>
											handleOptionChange('compact', e.target.checked)
										}
										className="mr-2"
									/>
							...
							<div className="space-y-2">
								...
								<div className="flex items-center">
									<input
										...
										onChange={(e) =>
											handleOptionChange('trailingComma', e.target.checked)
										}
										disabled={formatOptions.compact}
										className="mr-2"
									/>
									<label
										htmlFor="trailing-commas"
				...
				<Card>
					...
					<CardContent>
						...
						<div className="mt-2 text-gray-600 text-sm">
							...
							{formattedOutput.length} characters
						</div>
					</CardContent>
				</Card>
			)}
