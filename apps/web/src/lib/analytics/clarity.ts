...
export class MicrosoftClarityService {
  ...
  trackEvent(eventName: string, data?: Record<string, any>): void {
    ...
    try {
      ...
      this.debug('Failed to track event in Clarity', { eventName, data, error })
    }
  }
  ...
  identifyUser(userId: string, sessionId?: string, userAttributes?: Record<string, any>): void {
    ...
    try {
      ...
      this.debug('User identified in Clarity', { userId, sessionId, userAttributes })
    } catch (error) {
  ...
  setUserAttributes(attributes: Record<string, any>): void {
    ...
    try {
      ...
      this.debug('Failed to set user attributes in Clarity', { attributes, error })
    }
  }
